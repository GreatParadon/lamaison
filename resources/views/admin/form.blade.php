                        ...
                        <td colspan="2">
                            ...
                            @elseif($form['type'] == 'select')
                                <select class="form-control input-group-sm" id="{{ $form['field'] or '' }}"
                                        name="{{ $form['field'] or '' }}">
                                    @foreach($form['option'] as $r)
                                        <option value="{{  $r->id or '' }}"
                                                @if(isset($select)) @if($r->id == $select->$form['field']) selected @endif @endif>{{  $r->title_en or '' }}</option>
                                    @endforeach
                                </select>
                            ...
                            @elseif($form['type'] == 'color')
                                <input type="{{ $form['type'] or 'color' }}" name="{{ $form['field'] or '' }}"
                                       ...
                                       class="form-control input-group-sm" @if($form['required'] == true) required @endif>
                            @else
